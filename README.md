...
3. **Parse Data**: The app processes and organizes the data for generating emails.
4. **Recommendation Prompt**: 
   - A suggested prompt is generated based on the parsed data fields.
   - Customize the prompt using your data and placeholder columns.
5. **Generate Emails**: Personalized email content is created using the customized prompt.
6. **Preview and Send**: Review the generated emails and send them using the Gmail API.
