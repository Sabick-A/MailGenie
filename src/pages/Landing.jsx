                        ...
                        <div class="flex flex-wrap justify-between items-center mx-auto ">
                            <div className="flex items-center gap-10">
                                <Link className="block flex-shrink-0 " to="/">
                                    <img width={50} src={LogoIcon} alt="Logo" />
                                </Link>
                            ...
                            <div class="flex items-center justify-end lg:order-1 gap-10 ">
                                <DarkModeSwitcher />
                                {!loading && authStatus && <DropdownUser/>}
                            </div>
                        </div>
                    </nav>
                </header>
                    ...
                    <div class="grid py-8 px-6 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
                        <div class="place-self-center mr-auto lg:col-span-7">
                            ...
                            <p class="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                                ...
                                campaigns, businesses worldwide trust MailGenie
                                to streamline their email workflows.
                            </p>
                            {!loading && authStatus &&(
                                <button
                                    onClick={() => {
                                    ...
                                    class="bg-blue-700 w-full text-blue-400 border border-blue-400 border-b-4 font-medium overflow-hidden relative px-4 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group"
                                >
